...
public class Adapter extends RecyclerView.Adapter <Adapter.ViewHolder> {
    ...
    List<com.example.recyclerviewcolores.Color> misColores;
    Context miContexto;
    LayoutInflater miInflater;

    public Adapter( List<com.example.recyclerviewcolores.Color> misColores, Context contexto){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        com.example.recyclerviewcolores.Color color = misColores.get(position);
        holder.myTextView2.setText(color.getNombre() + "  " + misColores.size());
